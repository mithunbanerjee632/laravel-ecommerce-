...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/backend/dist/css/adminlte.css')}}"><!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
...
<div class="layout-fixed sidebar-expand-lg bg-body-tertiary">
       ...
       <!--end::Sidebar--> <!--begin::App Main-->
        ...
        <footer class="app-footer"> <!--begin::To the end-->
            <div class="float-end d-none d-sm-inline">Anything you want</div> <!--end::To the end--> <!--begin::Copyright--> <strong>
                ...
                <a href="#" class="text-decoration-none">Mithun Banerjee</a>.
            </strong>
            All rights reserved.
            <!--end::Copyright-->
        </footer> <!--end::Footer-->
    ...
    <script src="{{asset('public/backend/dist/js/adminlte.js')}}"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
    <script>
